...
* macOS for x86-64 (10.14 or later)
* Windows for x86

> **Note:** macOS binaries for arm64 aren't currently built. There are two limitations for this:
>
> 1. ISPC installed through homebrew only supports the current arch and arm64 VMs aren't currently available through Azure DevOps.
